package de.dgverlag.myapp.config;
...
public class CacheConfiguration {
    ...
    public InfinispanGlobalConfigurer globalConfiguration(JHipsterProperties jHipsterProperties) {
        ...
        return () ->
            GlobalConfigurationBuilder
                ...
                .defaultCacheName("infinispan-jhipsterSampleApplication20210223-cluster-cache")
                .transport()
                .defaultTransport()
                .addProperty("configurationFile", jHipsterProperties.getCache().getInfinispan().getConfigFile())
                .clusterName("infinispan-jhipsterSampleApplication20210223-cluster")
                .jmx()
    ...
    public InfinispanCacheConfigurer cacheConfigurer(JHipsterProperties jHipsterProperties) {
        ...
        return manager -> {
            ...
            Stream
                .of(
                    de.dgverlag.myapp.repository.UserRepository.USERS_BY_LOGIN_CACHE,
                    de.dgverlag.myapp.repository.UserRepository.USERS_BY_EMAIL_CACHE
                )
                .forEach(
                    cacheName ->
                        manager.defineConfiguration(
